  ...
  return (
    ...
    <div className="h-full bg-white">
      <div className="flex h-[100vh] w-full justify-center">
        <div className="flex h-[100vh] w-full max-w-lg flex-col border-primary sm:border-2  bg-secondary text-white p-8 overflow-auto">
          ...
          <ul className="list-disc">
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Jayveer Jyotish, the
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Jayveer Jyotish, 131, Nathubhai
                Tower, Oposite of Maruti suzuki showroom, Udhna main road,
          ...
          <ul>
            <li>
              <p>By email: jayveerastrology@gmail.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="https://jayveer-astrology.web.app"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://jayveer-astrology.web.app
                </a>
              </p>
            </li>
          </ul>
